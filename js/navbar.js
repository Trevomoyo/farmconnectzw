...
function renderNavbar(role) {
  const farmerLinks = `
    ...
    <a href="manage-my-farm.html">My Farm</a>
  ...
  const supplierLinks = `
    <a href="supplier-portal.html">Dashboard</a>
    <a href="marketplace.html">🛒 Marketplace</a>
    <a href="messages.html">Messages</a>
    <a href="profile.html">Profile</a>`;
  ...
  const adminLinks = `
    ...
    <a href="supplier-portal.html">Suppliers</a>
    <a href="marketplace.html">🛒 Marketplace</a>
    <a href="map.html">Map</a>
    <a href="market-prices.html">Prices</a>
    <a href="knowledge-hub.html">Learn</a>
  ...
  const links = role === 'administrator' ? adminLinks : role === 'extension_officer' ? officerLinks : role === 'supplier' ? supplierLinks : farmerLinks;
  const label = { farmer:'Farmer', extension_officer:'Officer', administrator:'Admin', supplier:'Supplier' }[role] || '';
